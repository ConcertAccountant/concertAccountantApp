  ...
  useEffect(() => {
    axios({
      ...
      setTicket({
        ...
        venue: id === "" ? "n/a" : response.data._embedded.venues[0].city.name,
      });
    });
  }, [id]);
        ...
        <div key={data.id}>
          <div className="contentInfo">
            ...
            <div className="infoContainer">
              <h2>{data.name}</h2>
              <h3>Venue: {data._embedded.venues[0].name}</h3>
              ...
              {data.priceRanges === undefined ? (
                ...
                <div>
                  ...
                  <p>Minimum price: ${Math.round(data.priceRanges[0].min)}</p>
                  <p>Maximum price: ${Math.round(data.priceRanges[0].max)}</p>
                </div>
              )}
            </div>
            <div className="getMoreInfo">
